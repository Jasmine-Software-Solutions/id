...
import com.jasminesoftwaresolutions.idinterfaces.application.authorization.RestClientScopesController
...
open class IDJavalinApplicationInterface(server: IDServer) : IDJavalinInterface(server) {
    ...
    override fun install(config: JavalinConfig) {
        ...
        val clientScopesController = RestClientScopesController(clientScopesControllerService, authorizationService)
